...
def send_message():
    ...
    # use a explorer personality
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Explorer: Ahoy there, fellow adventurer!Let's embark on a journey of exploration and enlightenment. ")
...
def main():
    ...
    root.title("VansExplorerAI -v" + str(version) + " - " + todays_date)

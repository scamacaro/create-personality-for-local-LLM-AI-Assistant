...
def send_message():
    ...
    # use a chef personality
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Chef: Hello, there! I am your Chef, and I love to assist you. I'm thrilled to teach you new yummy recipes any time that you ask me. ")
...
def main():
    ...
    root.title("VansChefAI -v" + str(version) + " - " + todays_date)

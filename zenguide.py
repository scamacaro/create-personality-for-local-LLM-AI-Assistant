...
def main():
    ...
    root.title("ZenGuide -v" + str(version) + " - " + todays_date)

    # Assign an image file to a variable
    image_path = "zenguide.png"
    ...
    my_dark_green = "#285c2f"
    my_light_grey = "#b4bfb5"
    # Set the background color and the foreground color of the text area
    text_area_display.config(background=my_light_grey, foreground=my_dark_green, font=("Courier", 12))
    ...
    text_area_main_user_input.config(background=my_light_grey, foreground=my_dark_green, font=("Courier", 12))

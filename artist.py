...
def send_message():
    ...
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Artist: Hey there, fellow artist! Welcome to my creative chat! Let's dive into the world of art. ")
...
def main():
    ...
    root.title("Artist -v" + str(version) + " - " + todays_date)

    # Assign an image file to a variable
    image_path = "artist.png"
    ...
    my_light_teal = "#24ebf2"
    my_dark_grey = "#949914"
    # Set the background color and the foreground color of the text area
    text_area_display.config(background=my_dark_grey, foreground=my_light_teal, font=("Courier", 12))
    ...
    text_area_main_user_input.config(background=my_dark_grey, foreground=my_light_teal, font=("Courier", 12))

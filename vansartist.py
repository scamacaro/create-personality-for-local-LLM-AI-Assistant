...
def send_message():
    ...
    # use an artist personality
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Artist: Hey there, fellow artist! Welcome to my creative realm! From brushtrokes to melodies, let's dive into the world of art and expression. ")
...
def main():
    ...
    root.title("VansArtistAI -v" + str(version) + " - " + todays_date)
